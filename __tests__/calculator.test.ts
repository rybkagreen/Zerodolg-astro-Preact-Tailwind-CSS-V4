...
describe('Calculator Component', () => {
      ...
      return {
        ...
        reason:
          debt < minimumDebt
            ...
            : debtToIncomeRatio > maximumDebtToIncome
  ...
  it('should validate calculator inputs correctly', () => {
    ...
    expect(negativeDependents.errors).toContain(
      'Количество иждивенцев не может быть отрицательным'
    );
  ...
  it('should include proper accessibility attributes', () => {
    ...
    expect(instructions.textContent).toBe(
      'Введите данные для расчета стоимости процедуры банкротства'
    );
