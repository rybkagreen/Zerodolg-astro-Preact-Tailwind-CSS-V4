...
const CONFIG = {
  YANDEX_METRIKA_ID: process.env.YANDEX_METRIKA_ID || '103604926',
  GOOGLE_ANALYTICS_ID: process.env.GOOGLE_ANALYTICS_ID || 'G-BDDN306E94',
  BITRIX24_WEBHOOK_URL: process.env.BITRIX24_WEBHOOK_URL || 'https://zerodolg.bitrix24.ru/rest/1/sn1lo90na6t13v1d/',
...
function trackCTAClicks() {
  document.addEventListener(
    'click',
    (e) => {
      const button = e.target.closest('.cta-primary, .btn-primary, .cta-button, button[type="submit"]');
      if (button) {
