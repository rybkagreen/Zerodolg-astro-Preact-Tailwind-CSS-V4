...
interface ReviewsCardsCleanProps {
  reviews: Review[];
  initialVisible?: number;
}

const ReviewsCardsClean = ({ reviews, initialVisible = 3 }: ReviewsCardsCleanProps) => {
    ...
    <div className='reviews-cards-wrapper'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
        {reviews.slice(0, visibleReviews).map((review, index) => (
          <div
            key={review.id}
            className='review-card-modern group relative bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:border-white/40 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/20'
          ...
          >
            ...
            {/* Verified Badge */}
            {review.verified && (
              <div className='absolute -top-3 -right-3 bg-gradient-to-br from-green-400 to-emerald-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg flex items-center gap-1 z-10'>
            ...
            <div className='mb-4'>
              <div className='flex items-start justify-between mb-3'>
                <div className='flex-1 min-w-0'>
                  <h3 className='text-white font-bold text-lg mb-1 group-hover:text-yellow-400 transition-colors truncate'>
            ...
            {/* Review Text - No line-clamp, full text always visible */}
...
export default ReviewsCardsClean;