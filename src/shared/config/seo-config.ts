...
export const SITE_CONFIG = {
  ...
  location: 'Москва',
  fullAddress: 'ул. Ярославская, 13Б, Москва, 129337',
...
export const SEO_CONFIG = {
  ...
  home: {
    ...
    description:
      'Списание долгов под ключ от 50000₽ за 4 месяца ⚡ Опыт 15 лет ⚡ 99% успешных дел ⚡ Остановим проценты и приставов ⚡ Консультация бесплатно',
  ...
  default: {
    ...
    description:
      '⭐ 99% успешных дел! Законное списание долгов через банкротство физических лиц. ✅ Остановим проценты ✅ Защитим имущество ✅ Гарантия по договору.',
