...
export const SITE_CONSTANTS = {
  ...
  legal: {
    law: {
      ...
      fullName: 'Работаем по ФЗ-№127 "О нестостоятельности"',
    },
    fedresurs: {
  ...
  seo: {
    ...
    description:
      '⭐ 99% успешных дел в Москве! Законное списание долгов через банкротство физических лиц. ✅ Остановим проценты ✅ Защитим имущество ✅ Гарантия по договору. 🎯 Консультация БЕСПЛАТНО!',
    keywords:
